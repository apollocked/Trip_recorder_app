          ...
          return Wrap(
            ...
            children: [
              ChoiceChip(
                ...
                onSelected: (selected) {
                  if (selected) themeService.setThemeMode(ThemeMode.light);
                },
              ),
              ChoiceChip(
              ...
              ChoiceChip(
                ...
                onSelected: (selected) {
                  if (selected) themeService.setThemeMode(ThemeMode.system);
                },
              ),
            ],
          );
...
class PrivacySection extends StatelessWidget {
  ...
  const PrivacySection({super.key, this.onNavigate});
